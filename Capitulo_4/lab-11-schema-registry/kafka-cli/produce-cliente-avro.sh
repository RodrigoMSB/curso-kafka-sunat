...
# CRÍTICO: produce CON KEY (el id del cliente como int Avro), porque la clave
# es lo que permite compactar el tópico y hacer joins por cliente.
...
if ficha_activa; then
    ...
    ficha_texto "Publicar el cliente ${ID} en Avro con su clave, que es lo que permite compactar el tópico y hacer joins por cliente"
