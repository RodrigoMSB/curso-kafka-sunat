...
ficha_op "INICIAR EL LAB 06" \
    ...
    "contenedores y volúmenes de novatech-lab06, y contenedores y redes vacías de otros labs novatech-lab*" \
...
echo ""
echo -e "${CYAN}  El recorrido de hoy - 4 pasos, unos 20 minutos:${NC}"
echo -e "    1. Crear ${BOLD}novatech.validacion${NC} con 3 particiones"
echo -e "    2. Un cocinero solo: se queda con las tres"
echo -e "    3. Entra el segundo, en el ${BOLD}mismo${NC} grupo: el trabajo se reparte"
echo -e "    4. Otra brigada, con ${BOLD}--group${NC} distinto: lee todo de nuevo"
echo ""
echo -e "${YELLOW}  Necesitas cuatro terminales. Los comandos del recorrido van${NC}"
echo -e "${YELLOW}  crudos, sin envoltorio, y están desglosados en la guía.${NC}"
echo ""
echo -e "${CYAN}  Envoltorios de kafka-cli - operan sobre ${BOLD}novatech.fleet.events${NC}${CYAN},${NC}"
echo -e "${CYAN}  que es el tópico de PARA PROFUNDIZAR F, no el del recorrido:${NC}"
...
echo ""
echo -e "${CYAN}  Y siempre:${NC}"
echo -e "    Detener laboratorio: ${BOLD}bin/stop-lab.sh${NC}"
echo ""
echo -e "${YELLOW}  Abre la guía: guia/01-grupos-y-quien-repartio-el-trabajo.md${NC}"
echo -e "${YELLOW}  Los pasos en seco, para la terminal: practica/PASOS.md${NC}"
echo ""
