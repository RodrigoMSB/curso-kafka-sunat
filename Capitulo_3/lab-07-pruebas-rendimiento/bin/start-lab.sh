...
echo -e "    ${BOLD}novatech.tuning.bench${NC}         - Para benchmarks de rendimiento"
echo ""
echo -e "${CYAN}  Comandos útiles:${NC}"
echo -e "    Rendimiento productor:   ${BOLD}kafka-cli/perf-test.sh <TOPIC> N [opciones]${NC}"
echo -e "    Rendimiento consumidor:  ${BOLD}kafka-cli/consumer-perf-test.sh <TOPIC> N [opciones]${NC}"
echo -e "    Detener laboratorio:     ${BOLD}bin/stop-lab.sh${NC}"
echo ""
echo -e "${CYAN}  El recorrido de hoy:${NC}"
echo -e "    1. Medir sin tocar nada, dos veces  -> ese es el ruido de tu máquina"
echo -e "    2. Cambiar UN parámetro (linger.ms) -> y medir dos veces más"
echo -e "    3. Un par más, y leer la tabla      -> ¿la mejora supera el ruido?"
echo ""
echo -e "${YELLOW}  Abre la guía: guia/01-medir-y-comparado-con-que.md${NC}"
