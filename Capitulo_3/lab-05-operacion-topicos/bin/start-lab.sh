...
ficha_op "INICIAR EL LAB 05" \
    ...
    "contenedores y volúmenes de novatech-lab05, y contenedores y redes vacías de otros labs novatech-lab*" \
...
echo ""
echo -e "${CYAN}  El recorrido de hoy - 5 pasos, unos 20 minutos:${NC}"
echo -e "    1. Crear ${BOLD}novatech.lab05.efimero${NC} con retención de 60 segundos"
echo -e "    2. Describirlo y leer la línea ${BOLD}Configs${NC}"
echo -e "    3. Escribir 100 comprobantes y contarlos por los dos extremos"
echo -e "    4. Cerrar el espiche con una segunda tanda de mensajes"
echo -e "    5. Esperar la ronda del broker, y contar de nuevo"
echo ""
...
echo ""
echo -e "${YELLOW}  Abre la guía: guia/01-retencion-y-si-nadie-los-borro.md${NC}"
echo -e "${YELLOW}  Los pasos en seco, para la terminal: practica/PASOS.md${NC}"
echo ""
echo -e "${CYAN}  El resto de la operación de tópicos -los cuatro perfiles de tópico,${NC}"
echo -e "${CYAN}  la compactación, el cambio en caliente, subir particiones- está en la${NC}"
echo -e "${CYAN}  sección PARA PROFUNDIZAR de esa misma guía, con su comando.${NC}"
echo ""
