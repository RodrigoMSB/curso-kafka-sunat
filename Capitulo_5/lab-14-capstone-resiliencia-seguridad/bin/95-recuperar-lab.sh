#!/bin/bash
# ============================================================
# Lab 14 - Recuperación del alumno (95)
...
if bash bin/90-test-lab.sh; then
    ...
    echo -e "${CYAN}  Clúster seguro regenerado (certificados nuevos). Continúa en la guía donde ibas; para el flujo completo automatizado: bin/run-capstone.sh.${NC}"
    exit 0
else
