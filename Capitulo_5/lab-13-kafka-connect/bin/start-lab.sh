...
ficha_op "INICIAR EL LAB 13" \
    ...
    "contenedores y volúmenes de novatech-lab13, y contenedores y redes vacías de otros labs novatech-lab*" \
...
echo -e "    PostgreSQL:         localhost:15432 (user: novatech, db: novatech_orders)"
