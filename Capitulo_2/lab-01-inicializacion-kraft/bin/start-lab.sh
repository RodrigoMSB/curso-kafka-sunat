...
# ============================================================
# NovaTech Logistics - Lab 01: levantar la solucion de referencia
# ============================================================
...
COMPOSE_FILE="${LAB_DIR}/soluciones/docker-compose-1-broker.SOLUCION.yml"
CONTENEDORES="kafka-broker"
...
echo -e "${YELLOW}[start-lab] levantando ${PROYECTO} desde soluciones/docker-compose-1-broker.SOLUCION.yml${NC}"
