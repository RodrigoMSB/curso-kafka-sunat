#!/bin/bash
# Crea los 2 tópicos del Lab 08 de manera idempotente.
set -euo pipefail
...
echo -e "${CYAN}[init-lab08-topics] Creando tópicos del Lab 08...${NC}"

create_topic_if_not_exists "novatech.lab08.transactions" 12 3 \
    "min.insync.replicas=2"

create_topic_if_not_exists "novatech.lab08.alerts" 3 3 \
    "min.insync.replicas=2"

echo -e "${GREEN}✓ Tópicos del Lab 08 inicializados${NC}"
